<x-app-layout>
                        ...
                        <tr data-id="{{ $item->id }}"
                            ...
                            <td class="px-6" id="edit">
                                <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                    <img src="{{ asset('images/edit.png') }}" class="w-4 mx-auto my-3"
                                        id="imagePreview">
                                </a>
                            </td>
                            <td class="px-6">
                                <a href="#" id="qr"
                                    ...
                                    <img src="{{ asset('images/qr.png') }}" class="w-4 mx-auto my-3">
                                </a>
                            </td>
    ...
    <script type="application/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#empTable').on('click', '#qr', function() {
                // Find the closest row to the clicked icon
                var row = $(this).closest('tr');
                
                // Extract the ID from the data-id attribute of the row
                var id = row.data('id');
                $.ajax({
                    url: '/employee/' + id,
                    ...
                    success: function(blobData, status, xhr) {
                        ...
                        // Use the blob URL as needed (e.g., for downloading the blob)
